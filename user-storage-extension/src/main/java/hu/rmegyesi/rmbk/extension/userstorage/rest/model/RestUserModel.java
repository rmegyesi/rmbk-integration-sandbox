package hu.rmegyesi.rmbk.extension.userstorage.rest.model;
...
public class RestUserModel extends AbstractUserAdapterFederatedStorage {

    private final UserEntity user;

    public RestUserModel(KeycloakSession session, RealmModel realm, ComponentModel storageProviderModel, UserEntity userEntity) {
    ...
    public Long getCreatedTimestamp() {
        return user.getCreatedAt().toEpochSecond();
    }

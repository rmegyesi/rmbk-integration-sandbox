...
You can then execute your native executable with: `./target/user-storage-app-1.0-SNAPSHOT-runner`
...
- Quarkus CXF
  OpenTelemetry ([guide](https://quarkiverse.github.io/quarkiverse-docs/quarkus-cxf/dev/reference/extensions/quarkus-cxf-integration-tracing-opentelemetry.html)):
  Collect metrics using https://micrometer.io/[Micrometer].
